...
def _build_figure_specs() -> tuple[FigureSpec, ...]:
    ...
    format_ladder = _registered_spec(
        summary=(
            ...
            "formats 0.3.0 and 0.3.1, the default 0.4.0 release-candidate wire profile, and opt-in 0.5.0 "
            "with exported-manifest context binding; the padded profiles use PADME length padding."
        ),
        ...
        caption=(
            ...
            "0.5.0 is opt-in with exported-manifest context binding, while 0.2.0, 0.3.0, and 0.3.1 remain "
