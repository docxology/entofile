...
- **Format ladder**: {{FORMAT_VERSION}} is the default on-disk contract. Compatibility formats {{FORMAT_VERSIONS_COMPATIBILITY}} are version-dispatched and remain readable/writable alongside it; older experimental ciphertext layouts are out of scope for this release.
...
| Swap manifest after export | Key-based decrypt mismatch; `verify_proof_export` consistency check [@rfc8785; @merkle1988digital; @haber1991timestamp] | Unkeyed proof is forgeable; sign externally for origin |
