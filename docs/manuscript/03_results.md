...
1. Runs `src/benchmarks.py::run_all_benchmarks` using parameters from `docs/manuscript/config.yaml` (`experiment.benchmark_repetitions`, `observability_levels`, `medium_track_bytes`).
