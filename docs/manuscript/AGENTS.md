...
Agent rules: [`../docs/agent_instructions.md`](../agent_instructions.md). This file covers ENTO-specific tokens, figures, and section map.
...
| `PAPER_TITLE` | `docs/manuscript/config.yaml` `paper.title` |
...
| `FIGURE_WIDTH` | Figure width percent from `docs/manuscript/config.yaml` |
...
See [`SYNTAX.md`](SYNTAX.md) and [`../docs/syntax_guide.md`](../syntax_guide.md).
